### Name: Ndata_processing_script.R
### Author: Jan Blanke
...
eu.nuts <- readOGR("/home/jan/Dropbox/Nitrogen_maps/CAPRI", "NUTS_ETRS_1989_LAEA")
...
setwd("/home/jan/Dropbox/Nitrogen_maps/CAPRI")
list.files()

## Read Elliot Nitrogen data
sp.nappl <- readRDS("/home/jan/Dropbox/Nitrogen_maps/Elliot/Elliot_spdf.rds")
